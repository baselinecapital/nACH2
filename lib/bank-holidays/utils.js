 ...
 * - saturday + 1 business day = tuesday (morning)
 * - sunday + 1 business day = tuesday (morning)
 *
 ...
 * - saturday + 2 business days = wednesday (morning)
 * - sunday + 2 business days = wednesday (morning)
 *
 ...
 * - saturday + 3 business days = thursday (morning)
 * - sunday + 3 business days = thursday (morning)
 *
 * Note: for saturdays, sundays and holidays we find morning of next business day
 * and only after that then start adding business days. This is made to avoid situation
 * when payment made at 11:00 on Saturday is processed BEFORE payment made on 12:00 on Sunday.
 * All payments made during a weekend should be processed at the same time
 *
